...
function getThemeColors(color: any, $theme: any) {
...
function changeThemeColor(newColor: any, $theme: any) {
...
function loadLocalTheme(localSetting: any) {
 ...
 * @returns {Object}
 */
function getLocalSetting(loadTheme: boolean) {
  let localSetting = {};
  try {
    const localSettingStr = (localStorage as any).getItem(
